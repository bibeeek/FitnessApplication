  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Consumer<AllInputsProvider>(builder: (context,value,child){
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  value.getSelectedAge < 26
                      ? boyimg
                      : value.getSelectedAge < 35
                      ? teenimg
                      : value.getSelectedAge < 60
                      ? dadimg
                      : oldimg,
                ],
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  NumberPicker(
                    ...
                    maxValue: 60,
                    value: (value.getSelectedAge),
                    onChanged: (newvalue) {
                      value.setSelectedAge(newvalue);
                    },
                    axis: Axis.vertical,
