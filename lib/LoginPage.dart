             ...
             mainAxisAlignment: MainAxisAlignment.start,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Image.asset("assets/gym1.png",width: double.infinity,height: 250,),
                ),
               ...
               // Text("Sign Up",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.black)),
                ...
                Text("Enter Valid Email & Password To Login" ,style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold,color: Colors.black54)),
                SizedBox(height: 20,),
